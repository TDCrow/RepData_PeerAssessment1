...
```{r histogram_of_total_number_of_steps_per_day_with_missing_values_ignored}
...
```{r time_series_plot_of_average_number_of_steps_averaged_across_all_days}
...
```{r histogram_of_total_number_of_steps_per_day_with_missing_values_included_as_the_average_of_the_inteval}
...
```{r Panel_plot_comparing_average_number_of_steps_per_inteval_split_by_weekend_or_weekday}
