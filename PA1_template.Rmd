...
```{r change the format of the date column}
...
```{r histogram of total number of steps per day with missing values ignored}
...
```{r time series plot of average number of steps averaged across all days}
...
```{r histogram of total number of steps per day with missing values included as the average of the inteval}
...
```{r Panel plot comparing average number of steps per inteval split by weekend or weekday}
